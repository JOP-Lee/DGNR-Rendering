...
class ExportPointCloud(Exporter):
    ...
    bound_size= 4
    bounding_box_min: Tuple[float, float, float] = (-1*bound_size, -1*bound_size, -1*bound_size)
    """Minimum of the bounding box, used if use_bounding_box is True."""
    bounding_box_max: Tuple[float, float, float] = (bound_size, bound_size, bound_size)
    """Maximum of the bounding box, used if use_bounding_box is True."""
    num_rays_per_batch: int = int(32768/4)
